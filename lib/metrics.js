...
Metrics.prototype.init = function(opts) {
	...
	if (!opts.hostedApiKey && opts.hostedApiKey !== false && process.env.HOSTEDGRAPHITE_APIKEY !== 'false') {
	...
	if (!opts.ftApiKey && opts.ftApiKey !== false && process.env.FT_GRAPHITE_APIKEY !== 'false') {
