...
Metrics.prototype.init = function(opts) {
	...
	this.graphite = new Graphite({
		apiKey: apiKey,
		prefix: this.opts.prefix || util.format('.%s.%s.%s.', platform, this.opts.app, instance),
		noLog: !isProduction
	});
	...
	if(typeof this.opts.useDefaultAggregators === 'undefined' || this.opts.useDefaultAggregators === true){
