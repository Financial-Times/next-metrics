...
var ExpressHttpResponse = module.exports = function ExpressHttpResponse() {
    this.counters = {
...
ExpressHttpResponse.prototype.instrument = function (res) {
...
ExpressHttpResponse.prototype.reset = function () {
    _.invoke(this.counters, 'clear');
};

ExpressHttpResponse.prototype.counts = function () {
    var c = this.counters;
    var obj = _.zipObject(
            [
        ...
        for(var i= 0, l=this.dynamicCounters.length; i<l; i++){
            ...
            Object.keys(counter).forEach(function(template){
                // replace characters the will look odd in metrics with underscore
...
ExpressHttpResponse.prototype._writeHead = function (fn, dt) {
    var self = this;
    return scarlet
        .intercept(fn)
