...
FtApi.prototype.instrument = function (obj) {
    ...
    this.setupRequestHandler('pages', obj);
    this.setupRequestHandler('elasticSearch', obj);

    obj.on('ft-api-client:v1:items:response', this.setupResponseHandler('items'));
    obj.on('ft-api-client:v1:search:response', this.setupResponseHandler('search'));
    obj.on('ft-api-client:v1:pages:response', this.setupResponseHandler('search'));
