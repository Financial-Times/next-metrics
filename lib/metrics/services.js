module.exports = {
	...
	'aws-elastic-v3-search': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic\.ft\.com)\/(v3_api_v2|content|embeds)\/(item\/)?_search/,
	'aws-elastic-v3-mget': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic\.ft\.com)\/(v3_api_v2|content|embeds)\/(item\/)?_mget/,
	'aws-elastic-v3-count': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic\.ft\.com)\/(v3_api_v2|content|embeds)\/(item\/)?_count/,
	'aws-elastic-v3-item': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic\.ft\.com)\/(v3_api_v2|content|embeds)\/item/,
	...
	'email-platform': /^https:\/\/(email-webservices\.ft\.com|ep\.ft\.com\/send-api)/,
	'email-webservices-api': /^https:\/\/(?:[A-F0-9]*:[A-F0-9]*@)?(email-webservices\.ft\.com|ep\.ft\.com\/send-api)\//,
