module.exports = {
	...
	'aws-elastic-v3-search': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic(\.glb)?\.ft\.com)\/(v3_api_v2|content|embeds)\/(item\/)?_search/,
	...
	'ft-next-enterprise-tools-membership-auth-svc': /^https?:\/\/api-authz-svc\.memb\.ft\.com\/api\/v2\/authorize/,
	'ft-next-enterprise-tools-b2b-fulfil-svc': /^https?:\/\/b2b-fulfil-svc-eu-prod\.memb\.ft\.com\/personalisedInvitations\/.*/,
	'ft-next-enterprise-tools-api-ft-com': /^https?:\/\/api\.ft\.com\/idm\/v1\/password-token/,
	...
	'kat-api-authorize': /^https?:\/\/api-authz-svc\.memb\.ft\.com\/api\/v2\/authorize/,
	...
	'navigation-origami-svc': /^https:\/\/www\.ft\.com\/__origami\/service\/navigation\/v2\/menus/,
	...
	'next-magnet-api-email-svc': /^https?:\/\/ep\.ft\.com\/user-lists\/users\/.*\/lists/,
	...
	'search-page-origami-svc': /^https?:\/\/www\.ft\.com\/__origami\/service\/navigation\/v2\/links/,
