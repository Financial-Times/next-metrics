module.exports = {
	...
	'redeemable-token-svc-ft-test': /^https:\/\/api-t.ft.com\/redeemable-tokens\//,
	'redeemable-token-svc-ft': /^https:\/\/api.ft.com\/redeemable-tokens\//,
	...
	'zuora-api-sandbox': /^https:\/\/apisandbox\.zuora\.com/,
	'zuora-rest-api-sandbox': /^https:\/\/rest\.apisandbox\.zuora\.com/,
	'zuora-rest-prod-payment': /^https:\/\/rest\.zuora\.com\/v1\/object\/payment\//,
	'zuora-rest-prod-account': /^https:\/\/rest\.zuora\.com\/v1\/object\/account\//,
	'zuora-rest-prod-sub-by-account': /^https:\/\/rest\.zuora\.com\/v1\/subscriptions\/accounts\//,
	'zuora-aqua-prod-batch-query': /^https:\/\/www\.zuora\.com\/apps\/api\/batch-query\//,
	'zuora-aqua-prod-job': /^https:\/\/www\.zuora\.com\/apps\/api\/batch-query\/jobs\//,
	'zuora-aqua-prod-file': /^https:\/\/www\.zuora\.com\/apps\/api\/file\//,
	...
	'trial-exclusions-svc': /^https?:\/\/api.ft.com\/trial-exclusions\/.*/
};
