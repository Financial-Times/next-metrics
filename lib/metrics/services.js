module.exports = {
	...
	'user-password-svc-RETIRED': /^https:\/\/user-cred-svc-gw-eu-west-1-prod\.memb\.ft\.com\/membership\/users\/[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12}\/credentials\/change-password/,
	'user-password-svc': /^https:\/\/(beta-)?api-t\.ft\.com\/membership\/users\/[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12}\/credentials\/change-password/,
	...
	'redeemable-token-svc-RETIRED-test': /^https:\/\/redeem-token-svc-gw-eu-west-1-test.memb.ft.com\//,
	'redeemable-token-svc-RETIRED': /^https:\/\/redeem-token-svc-gw-eu-west-1-prod.memb.ft.com\//,
	'redeemable-token-svc-test': /^https:\/\/api-t.ft.com\/redeemable-tokens\//,
	'redeemable-token-svc': /^https:\/\/api.ft.com\/redeemable-tokens\//,
