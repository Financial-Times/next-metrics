module.exports = {
	...
	'aws-elastic-v3-search': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic?(\.glb)?\.ft\.com|next-elasticsearch\.nlb\.ft\.com)\/(v3_api_v2|content|embeds)\/(item\/)?_search/,
	'aws-elastic-v3-mget': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic(\.glb)?\.ft\.com|next-elasticsearch\.nlb\.ft\.com)\/(v3_api_v2|content|embeds)\/(item\/)?_mget/,
	'aws-elastic-v3-count': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic(\.glb)?\.ft\.com|next-elasticsearch\.nlb\.ft\.com)\/(v3_api_v2|content|embeds)\/(item\/)?_count/,
	'aws-elastic-v3-item': /^https?:\/\/([\w\-]+\.[\w\-]+\.es\.amazonaws\.com|next-elastic(\.glb)?\.ft\.com|next-elasticsearch\.nlb\.ft\.com)\/(v3_api_v2|content|embeds)\/item/,
	...
	'ft-next-enterprise-tools': /^https?:\/\/enterprise-tools-(eu|us)\.herokuapp\.com\/__data\/.*/,
	...
	'membership-auth-svc': /^https?:\/\/api-authz-svc\.memb\.ft\.com\/api\/v2\/authorize/,
	'membership-b2b-fulfil-svc': /^https?:\/\/b2b-fulfil-svc-eu-prod\.memb\.ft\.com\/personalisedInvitations\/.*/,
