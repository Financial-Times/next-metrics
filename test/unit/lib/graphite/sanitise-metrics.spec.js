...
describe('lib/graphite/sanitise-metrics', () => {
    ...
    it('replace metrics name longer than 255 characters with keylengtherror. and last 5 characters of the long metrics name', () => {
    ...
    it('replace metrics name longer than 255 characters with keylengtherror. and last 5 characters without any dots of the long metrics name', () => {
